...
const History = () => {
  ...
  const loadConversations = async () => {
    try {
      const response = await fetch('${import.meta.env.VITE_API_URL}/get_conversations.php', {
        credentials: 'include',
      });
  ...
  const handleDeleteConversation = async (conversationId, e) => {
    ...
    try {
      const response = await fetch('${import.meta.env.VITE_API_URL}/delete_conversation.php', {
        method: 'DELETE',
        credentials: 'include',
