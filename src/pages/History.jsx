...
const History = () => {
  ...
  const loadConversations = async () => {
    try {
      const response = await fetch('https://soultalk-api.ct.ws/soulapp/php/get_conversations.php', {
        credentials: 'include',
      });
  ...
  const handleDeleteConversation = async (conversationId, e) => {
    ...
    try {
      const response = await fetch('https://soultalk-api.ct.ws/soulapp/php/delete_conversation.php', {
        method: 'DELETE',
        credentials: 'include',
