...
const Marketplace = () => {
  ...
  const loadCharacters = async () => {
    try {
      const response = await fetch(`https://soultalk-api.ct.ws/soulapp/php/marketplace.php?sort=${sortBy}`, {
        credentials: 'include'
      });
  ...
  const handleLike = async (characterId, e) => {
    ...
    try {
      const response = await fetch('https://soultalk-api.ct.ws/soulapp/php/marketplace.php', {
        method: 'POST',
